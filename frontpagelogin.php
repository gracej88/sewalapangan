      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#carouselExampleIndicators">Fasilitas</a>
            </li>
            <li class="nav-item">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="uploads/payment_proof/lapangan1.jfif" class="d-block w-100 carousel-image" alt="Lapangan 1">
          </div>
