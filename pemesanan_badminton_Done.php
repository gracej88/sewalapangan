...
if (isset($_POST['submit_booking']) || isset($_SESSION['booking_data'])) {
    ...
    if (strpos($field_name, 'Futsal') !== false) {
        $field_price = 120000; // Harga lapangan futsal
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto gap-5">
            <li class="nav-item">
              <a class="nav-link active" href="frontpagelogin.php">Beranda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="badminton_booking.php">Pesan</a>
            </li>
            <li class="nav-item">
